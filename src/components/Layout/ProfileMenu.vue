<template>
  <div class="relative inline-block text-left">
    ...
    <div @mousedown.prevent="1"
      class="origin-top-right absolute right-0 mt-2 w-56 transition ease-out duration-100 transform opacity-0 scale-95 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
      ...
      <span class="font-medium">zboru99@gmail.com</span></p>
      <hr>
      <div class="py-1" role="none">
        ...
        <a href="#" @click="logout" class="text-red-400 font-normal block px-4 py-2 text-sm hover:bg-gray-100 hover:text-red-900" role="menuitem" tabindex="-1"
           id="menu-item-3">Sign out</a>
