  ...
  <div class="border-2 p-2 mt-1 rounded flex flex-col">
    ...
    <div class="flex justify-between">
      <div class="flex justify-around mt-1 w-12">
        <t-icon @click="vote('upvote')" class="cursor-pointer hover:text-green-500" icon="bx:bx-upvote"></t-icon>
        <t-icon @click="vote('downvote')" class="cursor-pointer hover:text-red-500" icon="bx:bx-downvote"></t-icon>
      </div>
