		...
		<div v-if="gameExists" class="flex flex-col">
				...
				<div class="flex my-2">
					...
					<div class="mt-4 ml-4 flex-grow flex flex-col">
						...
						<div class="grid grid-cols-2 mt-4">
							<t-counter icon="heroicons-outline:heart" text="Favorite count"
									   :value="game.favorite_count"/>
							<t-counter icon="heroicons-outline:star" text="Rating" :value="game.rating"/>
							<t-counter class="mt-2" icon="heroicons-outline:play" text="Play count"
			...
			<div class="flex flex-col h-96">
				...
				<div class="no-scrollbar overflow-y-scroll">
					<game-comment v-for="(comment, index) in game.comments" :comment="comment"
								  :key="index"></game-comment>
