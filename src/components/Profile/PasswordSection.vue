      ...
      <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
          ...
          <p class="mt-1 text-sm text-gray-600">
            Set your new strong password here.
          </p>
        </div>
      </div>
      <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="shadow sm:rounded-md">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            <t-text-field placeholder="*********" v-model="password" label="New password"></t-text-field>
            <div>
              <div class="mt-1">
                <t-text-field label="Confirm password" v-model="confirmPassword" placeholder="*********"></t-text-field>
              </div>
            </div>
          </div>
